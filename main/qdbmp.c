...
/**************************************************************
	...
	and bit depth.
**************************************************************/
BMP* BMP_Create( unsigned int width, unsigned int height, unsigned short depth )
{
	BMP*	bmp;
...
BMP* BMP_ReadFile( const char* filename )
{
	...
	if ( bmp->Header.BitsPerPixel == 8 )
	{
		bmp->Palette = (unsigned char*) malloc( BMP_PALETTE_SIZE * sizeof( unsigned char ) );
		if ( bmp->Palette == NULL )
		{
			BMP_LAST_ERROR_CODE = BMP_OUT_OF_MEMORY;
			fclose( f );
	...
	bmp->Data = (unsigned char*) malloc( bmp->Header.ImageDataSize );
	if ( bmp->Data == NULL )
	{
		BMP_LAST_ERROR_CODE = BMP_OUT_OF_MEMORY;
		fclose( f );
...
void BMP_WriteFile( BMP* bmp, const char* filename )
{
	...
	if ( bmp->Palette )
	{
		if ( fwrite( bmp->Palette, sizeof( unsigned char ), BMP_PALETTE_SIZE, f ) != BMP_PALETTE_SIZE )
		{
			BMP_LAST_ERROR_CODE = BMP_IO_ERROR;
			fclose( f );
			return;
...
/**************************************************************
	...
	values.
**************************************************************/
void BMP_GetPixelRGB( BMP* bmp, unsigned int x, unsigned int y, unsigned char* r, unsigned char* g, unsigned char* b )
{
	unsigned char*	pixel;
	unsigned int	bytes_per_row;
...
**************************************************************/
void BMP_SetPixelRGB( BMP* bmp, unsigned int x, unsigned int y, unsigned char r, unsigned char g, unsigned char b )
{
	unsigned char*	pixel;
	unsigned int	bytes_per_row;
	unsigned char	bytes_per_pixel;
...
**************************************************************/
void BMP_GetPixelIndex( BMP* bmp, unsigned int x, unsigned int y, unsigned char* val )
{
	unsigned char*	pixel;
	unsigned int	bytes_per_row;
...
**************************************************************/
void BMP_SetPixelIndex( BMP* bmp, unsigned int x, unsigned int y, unsigned char val )
{
	unsigned char*	pixel;
	unsigned int	bytes_per_row;
...
**************************************************************/
void BMP_GetPaletteColor( BMP* bmp, unsigned char index, unsigned char* r, unsigned char* g, unsigned char* b )
{
	if ( bmp == NULL )
	{
		BMP_LAST_ERROR_CODE = BMP_INVALID_ARGUMENT;
...
**************************************************************/
void BMP_SetPaletteColor( BMP* bmp, unsigned char index, unsigned char r, unsigned char g, unsigned char b )
{
	if ( bmp == NULL )
	{
		BMP_LAST_ERROR_CODE = BMP_INVALID_ARGUMENT;
